...
const MockTest = () => {
  ...
  const navigateToCreateCourse = () => {
    navigate("/create-mock-test"); // Navigate to the Create Course page
  };

  return (
    <div className="p-8">
      <div className="text-2xl font-bold mb-2">Mock Tests</div>
      <div className="text-gray-500 mb-4">Welcome to your mock test dashboard</div>
